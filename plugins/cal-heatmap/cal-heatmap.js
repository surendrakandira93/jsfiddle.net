...
var CalHeatMap = function () {
	...
	this.options = {
		...
		subDomainTitleFormat: {
			empty: "{date}",
			filled: "{name} {connector} {date}:<b> {count}</b>"
		},
			...
			.call(function (selection) {
				...
				if (options.tooltip) {
					selection.on("mouseover", function (d) {
						...
						console.log(self.getSubDomainTitle(d));
						self.tooltip
...
CalHeatMap.prototype = {
	...
	fill: function (svg) {
		...
		rect.transition().duration(options.animationDuration).select("title")
			.text(function (d) { console.log(parent.getSubDomainTitle(d)); return parent.getSubDomainTitle(d); })
			;
	},
